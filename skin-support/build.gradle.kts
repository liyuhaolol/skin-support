...
centralPortal {
    ...
    pom {
        ...
        url = "https://github.com/liyuhaolol/skin-support"
        licenses {
            license {
                name = "The MIT License"
                url = "https://github.com/liyuhaolol/skin-support/blob/master/LICENSE"
            }
        }
        developers {
            developer {
        ...
        scm {
            connection = "scm:git@github.com/liyuhaolol/skin-support.git"
            developerConnection = "scm:git@github.com/liyuhaolol/skin-support.git"
            url = "https://github.com/liyuhaolol/skin-support"
        }
